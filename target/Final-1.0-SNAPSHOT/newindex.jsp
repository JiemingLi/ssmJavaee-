...
<div class="middle" id="middle" style="clear: both; height: 600px;">
    ...
    <div class="middle_h">
        ...
        <%--<div id="frame">--%>
        <%--<div id="photos">--%>
        <%--<img id="img1" src="apple.jpg" style="width:500px;height:200px" >--%>
        <%--<img id="img2" src="body.jpg" style="width:500px;height:200px">--%>
        <%--<img id="img3" src="eye.jpg " style="width:500px;height:200px">--%>
        <%--<img id="img4" src="face.jpg " style="width:500px;height:200px">--%>
        <%--</div>--%>
        <%--<div>--%>
        <%--<div class="box" id="move1">1</div>--%>
        <%--<div class="box" id="move2">2</div>--%>
        <%--<div class="box" id="move3">3</div>--%>
        <%--<div class="box" id="move4">4</div>--%>
        <%--</div>--%>
        <%--</div>--%>
